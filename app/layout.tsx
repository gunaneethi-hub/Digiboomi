...
export const metadata: Metadata = {
  ...
  title: {
    default: 'DigiBoomi – AI-Powered Digital Marketing Agency in Chennai | SEO, Ads & Web Design',
    template: '%s | DigiBoomi',
  },
  description:
    "DigiBoomi is Chennai's leading AI-powered digital marketing agency. We specialise in SEO, social media marketing, PPC advertising, and web design — helping Chennai businesses grow faster with smarter strategies.",
  keywords: [
  ...
  openGraph: {
    ...
    url: 'https://www.digiboomi.com',
    siteName: 'DigiBoomi',
    title: 'DigiBoomi – AI-Powered Digital Marketing Agency in Chennai | SEO, Ads & Web Design',
    description: "DigiBoomi is Chennai's leading AI-powered digital marketing agency. SEO, social media, PPC and web design — smarter strategies, faster growth.",
